  ...
  return (
    <div className="Cont">
      <div className="container">
        ...
        <section
          id="header"
          style={{ backgroundColor: "lightgrey", padding: "10px 0" }}
        >
        ...
        <div className="form">
          <div className="contact-info">
            ...
            <p className="text">
              For inquiries related to our library services, book availability,
              or any other questions, feel free to reach out to us.
            </p>
